...
const signup = async (req, res) => {
    ...
    try {
        ...
        const query = 'INSERT INTO students(username ,first_name , last_name, email, password,role_id , gender, generation) VALUES ( ?, ?,?, ?,?,?,?,?)';
        db.query(query, [username, first_name, last_name, email, hashedPassword, 2, gender, generation]);
        ...
        const sql = 'INSERT INTO users (student_id, teacher_id , role_id) VALUES ((SELECT student_id from students where username =?), ?, ?)';
