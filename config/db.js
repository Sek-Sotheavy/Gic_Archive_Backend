...
// db.query("CREATE TABLE IF NOT EXISTS comments (comment_id INT PRIMARY KEY AUTO_INCREMENT, project_id INT,thesis_id INT,student_id INT, comment_text TEXT, timestamps TIMESTAMP, FOREIGN KEY (project_id) REFERENCES classTeam_project(project_id),FOREIGN KEY (thesis_id) REFERENCES thesis(thesis_id), FOREIGN KEY (student_id) REFERENCES students(student_id)))", (createErr) => {
//         if (createErr) {
//                 console.error('Error creating the table:', createErr);
//         }
